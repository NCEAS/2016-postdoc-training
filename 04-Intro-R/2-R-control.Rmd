...
As we discuss previously R is built to work with vectors. The family of `apply` functions has been build to leverage vectorized operations that lower the explicit nee of `for` loops. Note that apply functions are in fact C for loops (faster).
